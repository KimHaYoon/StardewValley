...
HRESULT CSandy::Init()
{
	...
	m_strObjectKey = L"Sandy";
	m_strStateKey = L"Sandy_Forward";
	m_fSpeed = 10.f;
	m_tFrame = { 0.f, 4.f };
...
_int CSandy::Update(const _float & fTimeDelta)
{
...
void CSandy::LateUpdate(const _float & fTimeDelta)
{
	CObj::MoveFrame();
...
void CSandy::ChangeStateKey(DIR_ID eID)
{
	if (eID == DIR_ID_FORWORD)
		m_strStateKey = L"Sandy_Forward";
	else if (eID == DIR_ID_BACK)
		m_strStateKey = L"Sandy_Back";
	else if (eID == DIR_ID_LEFT)
		m_strStateKey = L"Sandy_Left";
	else if (eID == DIR_ID_RIGHT)
		m_strStateKey = L"Sandy_Right";
}

HRESULT CSandy::Init(OBJECT_ID eID)
{
	m_tInfo.vPos = { 100.f, 100.f,0.f };
	m_tInfo.vSize = { 1.f,1.f,0.f };
	m_strObjectKey = L"Sandy";
...
HRESULT CSandy::Init(LAYER_ID eID)
{
	m_tInfo.vPos = { 100.f, 100.f,0.f };
	m_tInfo.vSize = { 1.f,1.f,0.f };
	m_strObjectKey = L"Sandy";
