...
HRESULT CHaley::Init()
{
	...
	m_strObjectKey = L"Haley";
	m_strStateKey = L"Haley_Forward";
	m_fSpeed = 10.f;
	m_tFrame = { 0.f, 4.f };
...
_int CHaley::Update(const _float & fTimeDelta)
{
...
void CHaley::LateUpdate(const _float & fTimeDelta)
{
	CObj::MoveFrame();
...
void CHaley::ChangeStateKey(DIR_ID eID)
{
	if (eID == DIR_ID_FORWORD)
		m_strStateKey = L"Haley_Forward";
	else if (eID == DIR_ID_BACK)
		m_strStateKey = L"Haley_Back";
	else if (eID == DIR_ID_LEFT)
		m_strStateKey = L"Haley_Left";
	else if (eID == DIR_ID_RIGHT)
		m_strStateKey = L"Haley_Right";
}

HRESULT CHaley::Init(OBJECT_ID eID)
{
	m_tInfo.vPos = { 100.f, 100.f,0.f };
	m_tInfo.vSize = { 1.f,1.f,0.f };
	m_strObjectKey = L"Haley";
	...
	CObj* pObj = CAbstractFactory<CNameTag>::CreateObj(m_tInfo.vPos, L"Haley");
	if (pObj == nullptr)
		return E_FAIL;
...
HRESULT CHaley::Init(LAYER_ID eID)
{
	m_tInfo.vPos = { 100.f, 100.f,0.f };
	m_tInfo.vSize = { 1.f,1.f,0.f };
	m_strObjectKey = L"Haley";
