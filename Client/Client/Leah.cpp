...
HRESULT CLeah::Init()
{
	...
	m_strObjectKey = L"Leah";
	m_strStateKey = L"Leah_Forward";
	m_fSpeed = 10.f;
	m_tFrame = { 0.f, 4.f };
...
_int CLeah::Update(const _float & fTimeDelta)
{
...
void CLeah::LateUpdate(const _float & fTimeDelta)
{
	CObj::MoveFrame();
...
void CLeah::ChangeStateKey(DIR_ID eID)
{
	if (eID == DIR_ID_FORWORD)
		m_strStateKey = L"Leah_Forward";
	else if (eID == DIR_ID_BACK)
		m_strStateKey = L"Leah_Back";
	else if (eID == DIR_ID_LEFT)
		m_strStateKey = L"Leah_Left";
	else if (eID == DIR_ID_RIGHT)
		m_strStateKey = L"Leah_Right";
}

HRESULT CLeah::Init(OBJECT_ID eID)
{
	m_tInfo.vPos = { 100.f, 100.f,0.f };
	m_tInfo.vSize = { 1.f,1.f,0.f };
	m_strObjectKey = L"Leah";
...
HRESULT CLeah::Init(LAYER_ID eID)
{
	m_tInfo.vPos = { 100.f, 100.f,0.f };
	m_tInfo.vSize = { 1.f,1.f,0.f };
	m_strObjectKey = L"Leah";
